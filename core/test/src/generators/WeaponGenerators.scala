...
object WeaponGenerators {
  ...
  /**
    ...
    */
  def weaponGen(low: Int = -100, high: Int = 100)  = for {
  ...
  /**
    ...
    */
  def higherWeaponGen(low: Weapon = Weapon(-50)): Gen[Weapon] = weaponGen(low.value + 1, low.value + 100)
  /**
    * Generates random weapons that are lower than the specified one
    */
  def lowerWeaponGen(high: Weapon = Weapon(50)): Gen[Weapon] = weaponGen(high.value - 100, high.value - 1)
